...
class TensorBoardCallback(object):
    ...
    def __init__(self, dirname: str, metric_name: str) -> None:
        ...
        self._writer = tf.summary.create_file_writer(logdir=f'{dirname}')
    ...
    def __call__(self, study: optuna.study.Study, trial: optuna.trial.FrozenTrial) -> None:
        ...
        with self._writer.as_default():
            hp.hparams(hparams, trial_id=f'trial-{trial.number}')  # record the values used in this trial
    ...
    def _initialization(self, study: optuna.Study) -> None:
        ...
        with self._writer.as_default():
            hp.hparams_config(
                hparams=list(self._hp_params.values()),
                metrics=[hp.Metric(self._metric_name, display_name=self._metric_name)]
            )